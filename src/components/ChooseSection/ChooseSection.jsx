  ...
  return (
    <div>
        <div className="container">
            <h2 className='text-center mb-5'>Why choose Xaviers University ?</h2>
                ...
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            Xavier’s University is proud to have been recognized with two prestigious trophies in recent years. These accolades are a testament to our commitment to excellence in education, research, and community involvement
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className='text-center'>
                            At Xavier’s University, we prioritize the well-being and happiness of our students. We understand that a happy student is a successful student, which is why we offer a range of services and activities designed to support both academic and personal growth
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className='text-center'>
                            Xavier’s University is proud to have multiple campuses across India, offering students access to world-class education in several key locations Tirunelveli,Chennai and Coimbatore
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
