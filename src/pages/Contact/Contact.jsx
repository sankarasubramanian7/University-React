    ...
    <div className='contact-page'>
        <header className='height-75'>
            <div className='container h-100 d-flex flex-column align-items-center justify-content-center text-light'>
                ...
                <p className='text-center w-75 mb-5'>We'd love to hear from you! Whether you have questions about our programs, campus life, or admissions process, our team is here to assist you every step of the way. Reach out to us today and get all the information you need to start your journey at Xavier’s University. You can contact us via email, phone, or by filling out the contact form below</p>
            </div>
        </header>
            ...
            <div className='container'>
                ...
                <div className='row g-4'>
                    <div className='col-lg-4 d-flex flex-column align-items-center'>
                        ...
                        <h3 className='text-center mt-3'>Tirunelveli</h3>
                    </div>
                    <div className='col-lg-4 d-flex flex-column align-items-center'>
                        <img src={ManchesterLocationImg} className='img-fluid' alt="" />
                        <h3 className='text-center mt-3'>Chennai</h3>
                    </div>
                    <div className='col-lg-4 d-flex flex-column align-items-center'>
                        <img src={LiverpoolLocationImg} className='img-fluid' alt="" />
                        <h3 className='text-center mt-3'>Coimbatore</h3>
                    </div>
                </div>
            </div>
        </div>
